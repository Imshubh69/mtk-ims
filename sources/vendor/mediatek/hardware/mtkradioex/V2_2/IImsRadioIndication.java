...
public interface IImsRadioIndication extends vendor.mediatek.hardware.mtkradioex.V2_1.IImsRadioIndication {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@2.2::IImsRadioIndication";
    ...
    public static final class Proxy implements IImsRadioIndication {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@2.2::IImsRadioIndication]@Proxy";
            }
        }
        ...
        public void incomingCallIndication(int type, IncomingCallNotification inCallNotify) throws RemoteException {
            ...
            _hidl_request.writeInterfaceToken(vendor.mediatek.hardware.mtkradioex.V2_0.IImsRadioIndication.kInterfaceName);
        ...
        public void onMDInternetUsageInd(int type, ArrayList<Integer> info) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.mediatek.hardware.mtkradioex.V2_1.IImsRadioIndication.kInterfaceName);
            _hidl_request.writeInt32(type);
            _hidl_request.writeInt32Vector(info);
            HwParcel _hidl_reply = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements IImsRadioIndication {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IImsRadioIndication.kInterfaceName, vendor.mediatek.hardware.mtkradioex.V2_1.IImsRadioIndication.kInterfaceName, vendor.mediatek.hardware.mtkradioex.V2_0.IImsRadioIndication.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{21, -76, Byte.MAX_VALUE, 62, -122, -119, -23, -106, -53, -13, -55, -61, -122, 109, -76, 47, 18, 118, -43, -109, -123, 66, 87, 3, 45, 33, -116, -99, 31, 48, -22, -113}, new byte[]{65, 59, 49, 73, 91, -37, 21, -34, 113, 118, 93, 11, 84, -44, 61, -6, -70, 43, -72, 29, -68, -103, 52, 99, 108, 1, 112, -79, 3, -126, 40, 77}, new byte[]{-114, 48, 99, 32, -7, -94, -91, 68, 48, 32, 115, -18, 99, -57, -110, 31, -61, 90, 49, 94, -70, -64, 115, 9, -65, 81, -9, -98, -80, 114, 34, -85}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    hwParcel.enforceInterface(vendor.mediatek.hardware.mtkradioex.V2_0.IImsRadioIndication.kInterfaceName);
                ...
                case 53:
                    ...
                    return;
                case 54:
                    hwParcel.enforceInterface(vendor.mediatek.hardware.mtkradioex.V2_1.IImsRadioIndication.kInterfaceName);
