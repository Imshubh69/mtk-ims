...
public interface IImsRadioResponse extends vendor.mediatek.hardware.mtkradioex.V2_1.IImsRadioResponse {
    ...
    public static abstract class Stub extends HwBinder implements IImsRadioResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IImsRadioResponse.kInterfaceName, vendor.mediatek.hardware.mtkradioex.V2_1.IImsRadioResponse.kInterfaceName, vendor.mediatek.hardware.mtkradioex.V2_0.IImsRadioResponse.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                ...
                case 64:
                    ...
                    videoRingtoneEventResponse(info64);
                    return;
                case 256067662:
