...
public final class DedicateDataCall {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.ddcId = hwBlob.getInt32(_hidl_offset + 0);
        this.interfaceId = hwBlob.getInt32(_hidl_offset + 4);
        this.primaryCid = hwBlob.getInt32(_hidl_offset + 8);
        this.cid = hwBlob.getInt32(_hidl_offset + 12);
        this.active = hwBlob.getInt32(_hidl_offset + 16);
        this.signalingFlag = hwBlob.getInt32(_hidl_offset + 20);
        this.bearerId = hwBlob.getInt32(_hidl_offset + 24);
        this.failCause = hwBlob.getInt32(_hidl_offset + 28);
        this.hasQos = hwBlob.getInt32(_hidl_offset + 32);
        this.qos.readEmbeddedFromParcel(parcel, hwBlob, _hidl_offset + 36);
        this.hasTft = hwBlob.getInt32(_hidl_offset + 56);
        this.tft.readEmbeddedFromParcel(parcel, hwBlob, _hidl_offset + 64);
        this.hasPcscf = hwBlob.getInt32(_hidl_offset + 112);
        String string = hwBlob.getString(_hidl_offset + 120);
        this.pcscf = string;
        parcel.readEmbeddedBuffer((long) (string.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 120 + 0, false);
    }
