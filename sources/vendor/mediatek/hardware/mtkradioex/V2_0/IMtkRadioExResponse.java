...
public interface IMtkRadioExResponse extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@2.0::IMtkRadioExResponse";
    ...
    public static final class Proxy implements IMtkRadioExResponse {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@2.0::IMtkRadioExResponse]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IMtkRadioExResponse {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-77, -96, 39, 17, -80, -52, 16, -96, 45, 43, 27, -102, 25, 87, -88, -85, 97, 16, 84, -108, 54, 107, -29, -53, 85, 124, -20, 31, -8, -99, -125, -112}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 41:
                    ...
                    getCallSubAddressResponse(info38, _hidl_request.readInt32());
                    return;
                case 42:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                ...
                case 44:
                    ...
                    getATRResponse(info40, _hidl_request.readString());
                    return;
                case 45:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                    RadioResponseInfo info41 = new RadioResponseInfo();
                    info41.readFromParcel(hwParcel);
                    getIccidResponse(info41, _hidl_request.readString());
                    return;
                case 46:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                ...
                case 47:
                    ...
                    activateUiccCardRsp(info43, _hidl_request.readInt32());
                    return;
                case 48:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                    RadioResponseInfo info44 = new RadioResponseInfo();
                    info44.readFromParcel(hwParcel);
                    deactivateUiccCardRsp(info44, _hidl_request.readInt32());
                    return;
                case 49:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                    RadioResponseInfo info45 = new RadioResponseInfo();
                    info45.readFromParcel(hwParcel);
                    getCurrentUiccCardProvisioningStatusRsp(info45, _hidl_request.readInt32());
                    return;
                case 50:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                    RadioResponseInfo info46 = new RadioResponseInfo();
                    info46.readFromParcel(hwParcel);
                    queryNetworkLockResponse(info46, _hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32());
                    return;
                case 51:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                ...
                case 52:
                    ...
                    supplyDepersonalizationResponse(info48, _hidl_request.readInt32());
                    return;
                case 53:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                ...
                case 61:
                    ...
                    getGsmBroadcastLangsResponse(info57, _hidl_request.readString());
                    return;
                case 62:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                    RadioResponseInfo info58 = new RadioResponseInfo();
                    info58.readFromParcel(hwParcel);
                    getGsmBroadcastActivationRsp(info58, _hidl_request.readInt32());
                    return;
                case 63:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                    RadioResponseInfo info59 = new RadioResponseInfo();
                    info59.readFromParcel(hwParcel);
                    sendRequestRawResponse(info59, _hidl_request.readInt8Vector());
                    return;
                case 64:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                    RadioResponseInfo info60 = new RadioResponseInfo();
                    info60.readFromParcel(hwParcel);
                    sendRequestStringsResponse(info60, _hidl_request.readStringVector());
                    return;
                case 65:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                ...
                case 66:
                    ...
                    modifyModemTypeResponse(info62, _hidl_request.readInt32());
                    return;
                case 67:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                ...
                case LastCallFailCause.REQUESTED_FACILITY_NOT_IMPLEMENTED:
                    ...
                    getAvailableNetworksWithActResponse(info65, OperatorInfoWithAct.readVectorFromParcel(_hidl_request));
                    return;
                case 70:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                ...
                case 99:
                    ...
                    getApcInfoResponse(info75, _hidl_request.readInt32Vector());
                    return;
                case 100:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                ...
                case UtranBands.BAND_D:
                    ...
                    getLteReleaseVersionResponse(info80, _hidl_request.readInt32());
                    return;
                ...
                case 107:
                    ...
                    supplyDeviceNetworkDepersonalizationResponse(info83, _hidl_request.readInt32());
                    return;
                case 108:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                ...
                case 110:
                    ...
                    getPlmnNameFromSE13TableResponse(info86, _hidl_request.readString());
                    return;
                case 111:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                ...
                case 118:
                    ...
                    getDsdaStatusResponse(info94, _hidl_request.readInt32());
                    return;
                case 119:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                ...
                case 120:
                    ...
                    getSuggestedPlmnListResponse(responseInfo25, _hidl_request.readStringVector());
                    return;
                case 121:
                    hwParcel.enforceInterface(IMtkRadioExResponse.kInterfaceName);
                ...
                case 122:
                    ...
                    getDeactivateNrScgCommunicationResponse(responseInfo27, _hidl_request.readInt32(), _hidl_request.readInt32());
                    return;
