...
public final class SmsParams {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.format == other.format && this.f47vp == other.f47vp && this.pid == other.pid && this.dcs == other.dcs) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.format))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f47vp))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.pid))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.dcs)))});
    }

    public final String toString() {
        return "{" + ".format = " + this.format + ", .vp = " + this.f47vp + ", .pid = " + this.pid + ", .dcs = " + this.dcs + "}";
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.f47vp = _hidl_blob.getInt32(4 + _hidl_offset);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt32(4 + _hidl_offset, this.f47vp);
