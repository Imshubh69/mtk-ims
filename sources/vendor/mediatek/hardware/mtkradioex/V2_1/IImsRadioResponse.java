...
public interface IImsRadioResponse extends vendor.mediatek.hardware.mtkradioex.V2_0.IImsRadioResponse {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@2.1::IImsRadioResponse";
    ...
    static IImsRadioResponse asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static IImsRadioResponse castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static IImsRadioResponse getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IImsRadioResponse getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    @Deprecated
    static IImsRadioResponse getService(String serviceName) throws RemoteException {
    ...
    public static final class Proxy implements IImsRadioResponse {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@2.1::IImsRadioResponse]@Proxy";
            }
        }
        ...
        public void hangupAllResponse(RadioResponseInfo info) throws RemoteException {
            ...
            _hidl_request.writeInterfaceToken(vendor.mediatek.hardware.mtkradioex.V2_0.IImsRadioResponse.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements IImsRadioResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IImsRadioResponse.kInterfaceName, vendor.mediatek.hardware.mtkradioex.V2_0.IImsRadioResponse.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{55, -22, -69, -94, -28, 102, -78, -87, -109, 101, 116, 120, 63, -8, 17, 10, 37, Byte.MIN_VALUE, -14, -117, 65, 126, 99, -42, -3, -117, 5, -69, -121, 4, 112, -16}, new byte[]{6, 31, -80, 125, -12, -78, 125, -91, -7, -95, 113, -40, 90, -100, -93, -79, 59, -94, 87, 64, 59, -120, -80, -93, -88, 45, -119, 14, -57, 119, -127, -38}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                case 1:
                    _hidl_request.enforceInterface(vendor.mediatek.hardware.mtkradioex.V2_0.IImsRadioResponse.kInterfaceName);
                ...
                case 63:
                    ...
                    setCallAdditionalInfoResponse(info63);
                    return;
                case 256067662:
