...
public interface IMtkRadioEx extends IBase {
    ...
    public static final class Proxy implements IMtkRadioEx {
        ...
        public void setWifiAssociated(int serial, ArrayList<String> data) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IMtkRadioEx.kInterfaceName);
            _hidl_request.writeInt32(serial);
            _hidl_request.writeStringVector(data);
        ...
        public void setWifiIpAddress(int serial, ArrayList<String> data) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IMtkRadioEx.kInterfaceName);
            _hidl_request.writeInt32(serial);
            _hidl_request.writeStringVector(data);
        ...
        public void getWfcConfig(int serial, int setting) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IMtkRadioEx.kInterfaceName);
            _hidl_request.writeInt32(serial);
            _hidl_request.writeInt32(setting);
        ...
        public void setLocationInfo(int serial, ArrayList<String> data) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IMtkRadioEx.kInterfaceName);
            _hidl_request.writeInt32(serial);
            _hidl_request.writeStringVector(data);
        ...
        public void setResponseFunctionsSmartRatSwitch(ISmartRatSwitchRadioResponse radioResponse, ISmartRatSwitchRadioIndication radioIndication) throws RemoteException {
            ...
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact(ImsVTProvider.ConnectionEx.VideoProvider.SESSION_MODIFY_CANCEL_UPGRADE_FAIL, _hidl_request, _hidl_reply, 0);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
        ...
        public void disableAllCALinks(int serial, int linkType) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IMtkRadioEx.kInterfaceName);
            _hidl_request.writeInt32(serial);
            _hidl_request.writeInt32(linkType);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        public void getCALinkEnableStatus(int serial, String bandsCombo, int linkType) throws RemoteException {
            ...
            _hidl_request.writeInterfaceToken(IMtkRadioEx.kInterfaceName);
            _hidl_request.writeInt32(serial);
            _hidl_request.writeString(bandsCombo);
            _hidl_request.writeInt32(linkType);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        public void setLteBandEnableStatus(int serial, int bandId, boolean status) throws RemoteException {
            ...
            _hidl_request.writeInterfaceToken(IMtkRadioEx.kInterfaceName);
            _hidl_request.writeInt32(serial);
            _hidl_request.writeInt32(bandId);
            _hidl_request.writeBool(status);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        public void setBandPriorityList(int serial, ArrayList<Integer> bandPriList) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IMtkRadioEx.kInterfaceName);
            _hidl_request.writeInt32(serial);
        ...
        public void getCaBandMode(int serial, int primaryBandId) throws RemoteException {
            ...
            _hidl_request.writeInterfaceToken(IMtkRadioEx.kInterfaceName);
            _hidl_request.writeInt32(serial);
            _hidl_request.writeInt32(primaryBandId);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        public void setNrBandMode(int serial, ArrayList<Integer> saEnable, ArrayList<Integer> saDisable, ArrayList<Integer> nsaEnable, ArrayList<Integer> nsaDisable) throws RemoteException {
            ...
            _hidl_request.writeInterfaceToken(IMtkRadioEx.kInterfaceName);
            _hidl_request.writeInt32(serial);
            _hidl_request.writeInt32Vector(saEnable);
            _hidl_request.writeInt32Vector(saDisable);
            _hidl_request.writeInt32Vector(nsaEnable);
            _hidl_request.writeInt32Vector(nsaDisable);
            HwParcel _hidl_reply = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements IMtkRadioEx {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-126, -23, -31, -3, 20, 82, -4, -101, -46, -60, -10, -99, -112, 0, -90, 23, -37, 60, 84, 28, -66, -62, 68, 52, -8, 26, -10, 78, -81, -117, 7, 39}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 138:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    setWifiAssociated(_hidl_request.readInt32(), _hidl_request.readStringVector());
                    return;
                case 139:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                ...
                case 140:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    setWifiIpAddress(_hidl_request.readInt32(), _hidl_request.readStringVector());
                    return;
                case 141:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                ...
                case 142:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    getWfcConfig(_hidl_request.readInt32(), _hidl_request.readInt32());
                    return;
                case 143:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                ...
                case 144:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    setLocationInfo(_hidl_request.readInt32(), _hidl_request.readStringVector());
                    return;
                case 145:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                ...
                case 210:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    videoRingtoneEventRequest(_hidl_request.readInt32(), _hidl_request.readStringVector());
                    return;
                case SmsAcknowledgeFailCause.MEMORY_CAPACITY_EXCEEDED:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    setNROption(_hidl_request.readInt32(), _hidl_request.readInt32());
                    return;
                case 212:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    getTOEInfo(_hidl_request.readInt32());
                    return;
                case 213:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    disableAllCALinks(_hidl_request.readInt32(), _hidl_request.readInt32());
                    return;
                case 214:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    getCALinkEnableStatus(_hidl_request.readInt32(), _hidl_request.readString(), _hidl_request.readInt32());
                    return;
                case 215:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    setCALinkEnableStatus(_hidl_request.readInt32(), _hidl_request.readBool(), _hidl_request.readString(), _hidl_request.readInt32());
                    return;
                case 216:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    getCALinkCapabilityList(_hidl_request.readInt32(), _hidl_request.readInt32());
                    return;
                case 217:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    getLteData(_hidl_request.readInt32());
                    return;
                case 218:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    getLteRRCState(_hidl_request.readInt32());
                    return;
                case 219:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    setLteBandEnableStatus(_hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readBool());
                    return;
                case 220:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    getBandPriorityList(_hidl_request.readInt32());
                    return;
                case 221:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    setBandPriorityList(_hidl_request.readInt32(), _hidl_request.readInt32Vector());
                    return;
                case 222:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    set4x4MimoEnabled(_hidl_request.readInt32(), _hidl_request.readInt32());
                    return;
                case 223:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    get4x4MimoEnabled(_hidl_request.readInt32());
                    return;
                case 224:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    setLteBsrTimer(_hidl_request.readInt32(), _hidl_request.readInt32());
                    return;
                case 225:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    getLteBsrTimer(_hidl_request.readInt32());
                    return;
                case RadioCdmaSmsConst.UDH_OTHER_SIZE:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    getLte1xRttCellList(_hidl_request.readInt32(), _hidl_request.readBool());
                    return;
                case 227:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    clearLteAvailableFile(_hidl_request.readInt32());
                    return;
                case 228:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                ...
                case RadioCdmaSmsConst.USER_DATA_MAX:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    getCaBandMode(_hidl_request.readInt32(), _hidl_request.readInt32());
                    return;
                case 230:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    getCampedFemtoCellInfo(_hidl_request.readInt32());
                    return;
                case 231:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    setQamEnabled(_hidl_request.readInt32(), _hidl_request.readBool(), _hidl_request.readBool());
                    return;
                case 232:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    getQamEnabled(_hidl_request.readInt32(), _hidl_request.readBool());
                    return;
                case 233:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    setTm9Enabled(_hidl_request.readInt32(), _hidl_request.readBool(), _hidl_request.readBool());
                    return;
                case 234:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    getTm9Enabled(_hidl_request.readInt32(), _hidl_request.readBool());
                    return;
                case 235:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    setLteScanDuration(_hidl_request.readInt32(), _hidl_request.readInt32());
                    return;
                case 236:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    getLteScanDuration(_hidl_request.readInt32());
                    return;
                case 237:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                ...
                case LastCallFailCause.CALL_BARRED:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    getIWlanRegistrationState(_hidl_request.readInt32());
                    return;
                case LastCallFailCause.FDN_BLOCKED:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    getAllBandMode(_hidl_request.readInt32());
                    return;
                case LastCallFailCause.IMSI_UNKNOWN_IN_VLR:
                    hwParcel.enforceInterface(IMtkRadioEx.kInterfaceName);
                    setNrBandMode(_hidl_request.readInt32(), _hidl_request.readInt32Vector(), _hidl_request.readInt32Vector(), _hidl_request.readInt32Vector(), _hidl_request.readInt32Vector());
                    return;
                case 256067662:
