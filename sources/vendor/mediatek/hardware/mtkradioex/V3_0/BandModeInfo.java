...
public final class BandModeInfo {
    ...
    /* renamed from: sa */
    public ArrayList<Integer> f48sa = new ArrayList<>();
    public int umts = 0;
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.gsm == other.gsm && this.umts == other.umts && HidlSupport.deepEquals(this.lte, other.lte) && HidlSupport.deepEquals(this.f48sa, other.f48sa) && HidlSupport.deepEquals(this.nsa, other.nsa)) {
            return true;
        }
        return false;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size2; _hidl_index_02++) {
            this.f48sa.add(Integer.valueOf(childBlob2.getInt32((long) (_hidl_index_02 * 4))));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        int _hidl_vec_size2 = this.f48sa.size();
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size2; _hidl_index_02++) {
            childBlob2.putInt32((long) (_hidl_index_02 * 4), this.f48sa.get(_hidl_index_02).intValue());
        }
