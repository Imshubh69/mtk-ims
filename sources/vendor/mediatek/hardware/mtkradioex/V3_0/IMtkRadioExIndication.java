...
public interface IMtkRadioExIndication extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@3.0::IMtkRadioExIndication";
    ...
    void nrCaBandChangeInd(int i, ArrayList<Integer> arrayList) throws RemoteException;

    void nrSysInfoInd(int i, ArrayList<Integer> arrayList) throws RemoteException;

    void oemHookRaw(int i, ArrayList<Byte> arrayList) throws RemoteException;

    void on5GUWInfoInd(int i, ArrayList<Integer> arrayList) throws RemoteException;
    ...
    void oscFreqSwitchedInd(int i, int i2) throws RemoteException;
    ...
    public static final class Proxy implements IMtkRadioExIndication {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@3.0::IMtkRadioExIndication]@Proxy";
            }
        }
        ...
        public void onNwCfgInfoInd(int type, boolean mimo, boolean qam_256, boolean qam_ul64) throws RemoteException {
            ...
            _hidl_request.writeInterfaceToken(IMtkRadioExIndication.kInterfaceName);
            _hidl_request.writeInt32(type);
            _hidl_request.writeBool(mimo);
            _hidl_request.writeBool(qam_256);
            _hidl_request.writeBool(qam_ul64);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        public void nrCaBandChangeInd(int type, ArrayList<Integer> bands) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IMtkRadioExIndication.kInterfaceName);
            _hidl_request.writeInt32(type);
            _hidl_request.writeInt32Vector(bands);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        public void on5GUWInfoInd(int type, ArrayList<Integer> data) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IMtkRadioExIndication.kInterfaceName);
            _hidl_request.writeInt32(type);
            _hidl_request.writeInt32Vector(data);
        ...
        public void nrSysInfoInd(int type, ArrayList<Integer> nrSysInfos) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IMtkRadioExIndication.kInterfaceName);
            _hidl_request.writeInt32(type);
            _hidl_request.writeInt32Vector(nrSysInfos);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        public void oscFreqSwitchedInd(int type, int oscFreq) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IMtkRadioExIndication.kInterfaceName);
            _hidl_request.writeInt32(type);
            _hidl_request.writeInt32(oscFreq);
            HwParcel _hidl_reply = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements IMtkRadioExIndication {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-100, 93, 63, 81, -120, 48, -64, 80, 67, -87, -67, -97, 13, -55, 101, -116, -125, -84, 97, -124, -35, -103, -52, -88, 51, 101, -106, 85, -120, 90, 52, -63}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                ...
                case 68:
                    _hidl_request.enforceInterface(IMtkRadioExIndication.kInterfaceName);
                    toeInfoInd(_hidl_request.readInt32(), _hidl_request.readString(), _hidl_request.readString(), _hidl_request.readString());
                    return;
                case LastCallFailCause.REQUESTED_FACILITY_NOT_IMPLEMENTED:
                    _hidl_request.enforceInterface(IMtkRadioExIndication.kInterfaceName);
                    sib16TimeInfoInd(_hidl_request.readInt32(), _hidl_request.readString(), _hidl_request.readInt64());
                    return;
                case 70:
                    _hidl_request.enforceInterface(IMtkRadioExIndication.kInterfaceName);
                    onNwCfgInfoInd(_hidl_request.readInt32(), _hidl_request.readBool(), _hidl_request.readBool(), _hidl_request.readBool());
                    return;
                case 71:
                    _hidl_request.enforceInterface(IMtkRadioExIndication.kInterfaceName);
                    onNwRrcStateInd(_hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32());
                    return;
                case 72:
                    _hidl_request.enforceInterface(IMtkRadioExIndication.kInterfaceName);
                    iwlanRegistrationStateInd(_hidl_request.readInt32(), _hidl_request.readInt32());
                    return;
                case 73:
                    _hidl_request.enforceInterface(IMtkRadioExIndication.kInterfaceName);
                    nrCaBandChangeInd(_hidl_request.readInt32(), _hidl_request.readInt32Vector());
                    return;
                case 74:
                    _hidl_request.enforceInterface(IMtkRadioExIndication.kInterfaceName);
                    on5GUWInfoInd(_hidl_request.readInt32(), _hidl_request.readInt32Vector());
                    return;
                case 75:
                    _hidl_request.enforceInterface(IMtkRadioExIndication.kInterfaceName);
                    nrSysInfoInd(_hidl_request.readInt32(), _hidl_request.readInt32Vector());
                    return;
                case 76:
                    _hidl_request.enforceInterface(IMtkRadioExIndication.kInterfaceName);
                    oscFreqSwitchedInd(_hidl_request.readInt32(), _hidl_request.readInt32());
                    return;
                case 256067662:
