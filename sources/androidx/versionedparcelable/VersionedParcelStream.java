...
class VersionedParcelStream extends VersionedParcel {
    ...
    public VersionedParcelStream(InputStream input, OutputStream output) {
        this(input, output, new SimpleArrayMap(), new SimpleArrayMap(), new SimpleArrayMap());
    }

    private VersionedParcelStream(InputStream input, OutputStream output, SimpleArrayMap<String, Method> readCache, SimpleArrayMap<String, Method> writeCache, SimpleArrayMap<String, Class<?>> parcelizerCache) {
