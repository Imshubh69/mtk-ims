...
class VersionedParcelParcel extends VersionedParcel {
    ...
    VersionedParcelParcel(Parcel p) {
        this(p, p.dataPosition(), p.dataSize(), "", new SimpleArrayMap(), new SimpleArrayMap(), new SimpleArrayMap());
    }

    private VersionedParcelParcel(Parcel p, int offset, int end, String prefix, SimpleArrayMap<String, Method> readCache, SimpleArrayMap<String, Method> writeCache, SimpleArrayMap<String, Class<?>> parcelizerCache) {
