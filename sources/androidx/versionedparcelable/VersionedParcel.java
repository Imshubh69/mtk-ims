...
public abstract class VersionedParcel {
    ...
    VersionedParcel(SimpleArrayMap<String, Method> readCache, SimpleArrayMap<String, Method> writeCache, SimpleArrayMap<String, Class<?>> parcelizerCache) {
    ...
    private Method getWriteMethod(Class<?> baseCls) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        ...
        Method m2 = findParcelClass(baseCls).getDeclaredMethod("write", new Class[]{baseCls, VersionedParcel.class});
