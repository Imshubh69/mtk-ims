...
import androidx.lifecycle.viewmodel.C0086R;
...
public class ViewTreeViewModelStoreOwner {
    ...
    public static void set(View view, ViewModelStoreOwner viewModelStoreOwner) {
        view.setTag(C0086R.C0088id.view_tree_view_model_store_owner, viewModelStoreOwner);
    }
    ...
    public static androidx.lifecycle.ViewModelStoreOwner get(android.view.View r4) {
        /*
            int r0 = androidx.lifecycle.viewmodel.C0086R.C0088id.view_tree_view_model_store_owner
        ...
        L_0x000f:
            ...
            int r3 = androidx.lifecycle.viewmodel.C0086R.C0088id.view_tree_view_model_store_owner
