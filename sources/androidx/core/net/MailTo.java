...
public final class MailTo {
    ...
    /* renamed from: CC */
    private static final String f34CC = "cc";
    private static final String MAILTO = "mailto";
    public static final String MAILTO_SCHEME = "mailto:";
    private static final String SUBJECT = "subject";

    /* renamed from: TO */
    private static final String f35TO = "to";
    ...
    public static MailTo parse(String uri) throws ParseException {
        ...
        if (isMailTo(uri)) {
            ...
            mailTo.mHeaders.put(f35TO, address);
            return mailTo;
        }
    ...
    public String getTo() {
        return this.mHeaders.get(f35TO);
    }

    public String getCc() {
        return this.mHeaders.get(f34CC);
    }
