...
public class FontResourcesParserCompat {
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        TypedArray array = resources.obtainAttributes(Xml.asAttributeSet(parser), C0008R.styleable.FontFamily);
        ...
        String systemFontFamilyName = array.getString(C0008R.styleable.FontFamily_fontProviderSystemFontFamily);
        array.recycle();
    ...
    private static FontFileResourceEntry readFont(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        ...
        int i2;
        TypedArray array = resources.obtainAttributes(Xml.asAttributeSet(parser), C0008R.styleable.FontFamilyFont);
        if (array.hasValue(C0008R.styleable.FontFamilyFont_fontWeight)) {
            weightAttr = C0008R.styleable.FontFamilyFont_fontWeight;
        } else {
            weightAttr = C0008R.styleable.FontFamilyFont_android_fontWeight;
        }
        int weight = array.getInt(weightAttr, NORMAL_WEIGHT);
        if (array.hasValue(C0008R.styleable.FontFamilyFont_fontStyle)) {
            styleAttr = C0008R.styleable.FontFamilyFont_fontStyle;
        } else {
            styleAttr = C0008R.styleable.FontFamilyFont_android_fontStyle;
        }
        boolean isItalic = 1 == array.getInt(styleAttr, 0);
        if (array.hasValue(C0008R.styleable.FontFamilyFont_ttcIndex)) {
            i = C0008R.styleable.FontFamilyFont_ttcIndex;
        } else {
            i = C0008R.styleable.FontFamilyFont_android_ttcIndex;
        }
        int ttcIndexAttr = i;
        if (array.hasValue(C0008R.styleable.FontFamilyFont_fontVariationSettings)) {
            variationSettingsAttr = C0008R.styleable.FontFamilyFont_fontVariationSettings;
        } else {
            variationSettingsAttr = C0008R.styleable.FontFamilyFont_android_fontVariationSettings;
        }
        String variationSettings = array.getString(variationSettingsAttr);
        int ttcIndex = array.getInt(ttcIndexAttr, 0);
        if (array.hasValue(C0008R.styleable.FontFamilyFont_font)) {
            i2 = C0008R.styleable.FontFamilyFont_font;
        } else {
            i2 = C0008R.styleable.FontFamilyFont_android_font;
        }
        int resourceAttr = i2;
