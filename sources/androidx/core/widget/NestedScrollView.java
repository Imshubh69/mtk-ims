...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public NestedScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, C0008R.attr.nestedScrollViewStyle);
    }
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        int i = ImsCallSessionProxy.CALL_INFO_MSG_TYPE_MO_CALL_ID_ASSIGN;
        if (!canScroll) {
            ...
            View nextFocused = FocusFinder.getInstance().findNextFocus(this, currentFocused, ImsCallSessionProxy.CALL_INFO_MSG_TYPE_MO_CALL_ID_ASSIGN);
            if (nextFocused == null || nextFocused == this || !nextFocused.requestFocus(ImsCallSessionProxy.CALL_INFO_MSG_TYPE_MO_CALL_ID_ASSIGN)) {
                return false;
            }
            return true;
            ...
            switch (event.getKeyCode()) {
                ...
                case 20:
                    if (!event.isAltPressed()) {
                        return arrowScroll(ImsCallSessionProxy.CALL_INFO_MSG_TYPE_MO_CALL_ID_ASSIGN);
                    }
                    return fullScroll(ImsCallSessionProxy.CALL_INFO_MSG_TYPE_MO_CALL_ID_ASSIGN);
                case 62:
    ...
    public final void smoothScrollBy(int dx, int dy) {
        smoothScrollBy(dx, dy, LastCallFailCause.RADIO_INTERNAL_ERROR, false);
    }
    ...
    public final void smoothScrollTo(int x, int y) {
        smoothScrollTo(x, y, LastCallFailCause.RADIO_INTERNAL_ERROR, false);
    }
    ...
    public void smoothScrollTo(int x, int y, boolean withNestedScrolling) {
        smoothScrollTo(x, y, LastCallFailCause.RADIO_INTERNAL_ERROR, withNestedScrolling);
    }
    ...
    public boolean onRequestFocusInDescendants(int direction, Rect previouslyFocusedRect) {
        View nextFocus;
        if (direction == 2) {
            direction = ImsCallSessionProxy.CALL_INFO_MSG_TYPE_MO_CALL_ID_ASSIGN;
        } else if (direction == 1) {
            direction = 33;
        }
