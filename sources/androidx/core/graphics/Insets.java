...
public final class Insets {
    ...
    /* renamed from: of */
    public static Insets m12of(int left2, int top2, int right2, int bottom2) {
    ...
    /* renamed from: of */
    public static Insets m13of(Rect r) {
        return m12of(r.left, r.top, r.right, r.bottom);
    }

    public static Insets add(Insets a, Insets b) {
        return m12of(a.left + b.left, a.top + b.top, a.right + b.right, a.bottom + b.bottom);
    }
    ...
    public static Insets max(Insets a, Insets b) {
        return m12of(Math.max(a.left, b.left), Math.max(a.top, b.top), Math.max(a.right, b.right), Math.max(a.bottom, b.bottom));
    }

    public static Insets min(Insets a, Insets b) {
        return m12of(Math.min(a.left, b.left), Math.min(a.top, b.top), Math.min(a.right, b.right), Math.min(a.bottom, b.bottom));
    }
    ...
    public static Insets toCompatInsets(android.graphics.Insets insets) {
        return m12of(insets.left, insets.top, insets.right, insets.bottom);
    }
