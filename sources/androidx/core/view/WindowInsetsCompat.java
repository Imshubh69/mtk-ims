...
public class WindowInsetsCompat {
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int left, int top, int right, int bottom) {
        return new Builder(this).setSystemWindowInsets(Insets.m12of(left, top, right, bottom)).build();
    }

    @Deprecated
    public WindowInsetsCompat replaceSystemWindowInsets(Rect systemWindowInsets) {
        return new Builder(this).setSystemWindowInsets(Insets.m13of(systemWindowInsets)).build();
    }
    ...
    private static class Impl20 extends Impl {
        ...
        public Insets getInsetsForType(int type, boolean ignoreVisibility) {
            ...
            switch (type) {
                case 1:
                    if (ignoreVisibility) {
                        return Insets.m12of(0, Math.max(getRootStableInsets().top, getSystemWindowInsets().top), 0, 0);
                    }
                    return Insets.m12of(0, getSystemWindowInsets().top, 0, 0);
                case 2:
                    if (ignoreVisibility) {
                        Insets rootStable = getRootStableInsets();
                        Insets stable = getStableInsets();
                        return Insets.m12of(Math.max(rootStable.left, stable.left), 0, Math.max(rootStable.right, stable.right), Math.max(rootStable.bottom, stable.bottom));
                    }
                    ...
                    return Insets.m12of(systemWindow.left, 0, systemWindow.right, bottom);
                case 8:
                    ...
                    if (systemWindow2.bottom > rootStable2.bottom) {
                        return Insets.m12of(0, 0, 0, systemWindow2.bottom);
                    }
                    ...
                    return Insets.m12of(0, 0, 0, this.mRootViewVisibleInsets.bottom);
                case 16:
                ...
                case 128:
                    ...
                    if (cutout != null) {
                        return Insets.m12of(cutout.getSafeInsetLeft(), cutout.getSafeInsetTop(), cutout.getSafeInsetRight(), cutout.getSafeInsetBottom());
                    }
                    return Insets.NONE;
                default:
                    return Insets.NONE;
        ...
        public final Insets getSystemWindowInsets() {
            if (this.mSystemWindowInsets == null) {
                this.mSystemWindowInsets = Insets.m12of(this.mPlatformInsets.getSystemWindowInsetLeft(), this.mPlatformInsets.getSystemWindowInsetTop(), this.mPlatformInsets.getSystemWindowInsetRight(), this.mPlatformInsets.getSystemWindowInsetBottom());
            }
        ...
        private Insets getVisibleInsets(View rootView) {
            if (Build.VERSION.SDK_INT < 30) {
                ...
                try {
                    ...
                    if (visibleRect != null) {
                        return Insets.m13of(visibleRect);
                    }
                    return null;
    ...
    private static class Impl21 extends Impl20 {
        ...
        public final Insets getStableInsets() {
            if (this.mStableInsets == null) {
                this.mStableInsets = Insets.m12of(this.mPlatformInsets.getStableInsetLeft(), this.mPlatformInsets.getStableInsetTop(), this.mPlatformInsets.getStableInsetRight(), this.mPlatformInsets.getStableInsetBottom());
            }
    ...
    static Insets insetInsets(Insets insets, int left, int top, int right, int bottom) {
        ...
        return Insets.m12of(newLeft, newTop, newRight, newBottom);
    }
            ...
            try {
                ...
                if (attachInfo != null) {
                    ...
                    if (!(stableInsets == null || visibleInsets == null)) {
                        WindowInsetsCompat insets = new Builder().setStableInsets(Insets.m13of(stableInsets)).setSystemWindowInsets(Insets.m13of(visibleInsets)).build();
