...
public final class WindowInsetsAnimationCompat {
    ...
    private static class Impl21 extends Impl {
        ...
        static void setCallback(View view, Callback callback) {
            Object userListener = view.getTag(C0008R.C0010id.tag_on_apply_window_listener);
            if (callback == null) {
                view.setTag(C0008R.C0010id.tag_window_insets_animation_callback, (Object) null);
            ...
            view.setTag(C0008R.C0010id.tag_window_insets_animation_callback, proxyListener);
            if (userListener == null) {
        ...
        private static class Impl21OnApplyWindowInsetsListener implements View.OnApplyWindowInsetsListener {
            ...
            public WindowInsets onApplyWindowInsets(View v, WindowInsets insets) {
                ...
                C00651 r9 = r0;
                final View view2 = v;
                C00651 r0 = new ValueAnimator.AnimatorUpdateListener() {
        ...
        static WindowInsets forwardToViewIfNeeded(View v, WindowInsets insets) {
            if (v.getTag(C0008R.C0010id.tag_on_apply_window_listener) != null) {
                return insets;
            }
        ...
        static Callback getCallback(View child) {
            Object listener = child.getTag(C0008R.C0010id.tag_window_insets_animation_callback);
