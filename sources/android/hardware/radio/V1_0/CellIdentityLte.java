...
public final class CellIdentityLte {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(this.mcc, other.mcc) && HidlSupport.deepEquals(this.mnc, other.mnc) && this.f4ci == other.f4ci && this.pci == other.pci && this.tac == other.tac && this.earfcn == other.earfcn) {
            return true;
        }
        return false;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.f4ci = hwBlob.getInt32(_hidl_offset + 32);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt32(32 + _hidl_offset, this.f4ci);
