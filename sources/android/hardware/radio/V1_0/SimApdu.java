...
public final class SimApdu {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.sessionId == other.sessionId && this.cla == other.cla && this.instruction == other.instruction && this.f12p1 == other.f12p1 && this.f13p2 == other.f13p2 && this.f14p3 == other.f14p3 && HidlSupport.deepEquals(this.data, other.data)) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.sessionId))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.cla))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.instruction))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f12p1))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f13p2))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f14p3))), Integer.valueOf(HidlSupport.deepHashCode(this.data))});
    }

    public final String toString() {
        return "{" + ".sessionId = " + this.sessionId + ", .cla = " + this.cla + ", .instruction = " + this.instruction + ", .p1 = " + this.f12p1 + ", .p2 = " + this.f13p2 + ", .p3 = " + this.f14p3 + ", .data = " + this.data + "}";
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.f12p1 = hwBlob.getInt32(_hidl_offset + 12);
        this.f13p2 = hwBlob.getInt32(_hidl_offset + 16);
        this.f14p3 = hwBlob.getInt32(_hidl_offset + 20);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt32(12 + _hidl_offset, this.f12p1);
        _hidl_blob.putInt32(16 + _hidl_offset, this.f13p2);
        _hidl_blob.putInt32(20 + _hidl_offset, this.f14p3);
