...
public final class IccIo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.command == other.command && this.fileId == other.fileId && HidlSupport.deepEquals(this.path, other.path) && this.f5p1 == other.f5p1 && this.f6p2 == other.f6p2 && this.f7p3 == other.f7p3 && HidlSupport.deepEquals(this.data, other.data) && HidlSupport.deepEquals(this.pin2, other.pin2) && HidlSupport.deepEquals(this.aid, other.aid)) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.command))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.fileId))), Integer.valueOf(HidlSupport.deepHashCode(this.path)), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f5p1))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f6p2))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.f7p3))), Integer.valueOf(HidlSupport.deepHashCode(this.data)), Integer.valueOf(HidlSupport.deepHashCode(this.pin2)), Integer.valueOf(HidlSupport.deepHashCode(this.aid))});
    }

    public final String toString() {
        return "{" + ".command = " + this.command + ", .fileId = " + this.fileId + ", .path = " + this.path + ", .p1 = " + this.f5p1 + ", .p2 = " + this.f6p2 + ", .p3 = " + this.f7p3 + ", .data = " + this.data + ", .pin2 = " + this.pin2 + ", .aid = " + this.aid + "}";
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.f5p1 = hwBlob.getInt32(_hidl_offset + 24);
        this.f6p2 = hwBlob.getInt32(_hidl_offset + 28);
        this.f7p3 = hwBlob.getInt32(_hidl_offset + 32);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt32(24 + _hidl_offset, this.f5p1);
        _hidl_blob.putInt32(28 + _hidl_offset, this.f6p2);
        _hidl_blob.putInt32(32 + _hidl_offset, this.f7p3);
