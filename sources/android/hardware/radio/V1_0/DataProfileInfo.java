...
public final class DataProfileInfo {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        String string3 = hwBlob.getString(_hidl_offset + 40);
        this.roamingProtocol = string3;
        parcel.readEmbeddedBuffer((long) (string3.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 40 + 0, false);
        this.authType = hwBlob.getInt32(_hidl_offset + 56);
        String string4 = hwBlob.getString(_hidl_offset + 64);
        this.user = string4;
        parcel.readEmbeddedBuffer((long) (string4.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 64 + 0, false);
        String string5 = hwBlob.getString(_hidl_offset + 80);
        ...
        String string6 = hwBlob.getString(_hidl_offset + 136);
        this.mvnoMatchData = string6;
        parcel.readEmbeddedBuffer((long) (string6.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 136 + 0, false);
    }
