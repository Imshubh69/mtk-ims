...
public interface IRadio extends android.hardware.radio.V1_3.IRadio {
    ...
    public static abstract class Stub extends HwBinder implements IRadio {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IRadio.kInterfaceName, android.hardware.radio.V1_3.IRadio.kInterfaceName, android.hardware.radio.V1_2.IRadio.kInterfaceName, android.hardware.radio.V1_1.IRadio.kInterfaceName, android.hardware.radio.V1_0.IRadio.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 102:
                    ...
                    return;
                case UtranBands.BAND_C /*103*/:
                    hwParcel.enforceInterface(android.hardware.radio.V1_0.IRadio.kInterfaceName);
                    getImsRegistrationState(_hidl_request.readInt32());
                    return;
                case UtranBands.BAND_D /*104*/:
                    hwParcel.enforceInterface(android.hardware.radio.V1_0.IRadio.kInterfaceName);
                ...
                case 148:
                    hwParcel.enforceInterface(IRadio.kInterfaceName);
                    setDataProfile_1_4(_hidl_request.readInt32(), DataProfileInfo.readVectorFromParcel(_hidl_request));
                    return;
                case 149:
                    hwParcel.enforceInterface(IRadio.kInterfaceName);
