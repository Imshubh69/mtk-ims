...
public final class CellIdentity {
    ...
    public static final class hidl_discriminator {
        ...
        /* renamed from: nr */
        public static final byte f22nr = 6;
    ...
    /* renamed from: nr */
    public void mo1494nr(CellIdentityNr nr) {
        this.hidl_d = 6;
        this.hidl_o = nr;
    }

    /* renamed from: nr */
    public CellIdentityNr mo1493nr() {
        if (this.hidl_d != 6) {
            Object obj = this.hidl_o;
            String className = obj != null ? obj.getClass().getName() : "null";
            throw new IllegalStateException("Read access to inactive union components is disallowed. Discriminator value is " + this.hidl_d + " (corresponding to " + hidl_discriminator.getName(this.hidl_d) + "), and hidl_o is of type " + className + ".");
    ...
    public final void readFromParcel(HwParcel parcel) {
        readEmbeddedFromParcel(parcel, parcel.readBuffer(168), 0);
    }
    ...
    public static final ArrayList<CellIdentity> readVectorFromParcel(HwParcel parcel) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 168), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            CellIdentity _hidl_vec_element = new CellIdentity();
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, (long) (_hidl_index_0 * 168));
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<CellIdentity> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            _hidl_vec.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 168));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        switch (this.hidl_d) {
            ...
            case 5:
                ...
                return;
            case 6:
                mo1493nr().writeEmbeddedToBlob(_hidl_blob, 8 + _hidl_offset);
                return;
            default:
                throw new Error("Unknown union discriminator (value: " + this.hidl_d + ").");
        }
