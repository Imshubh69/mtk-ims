...
public final class CellInfo {
    ...
    public static final class CellInfoRatSpecificInfo {
        ...
        public static final class hidl_discriminator {
            ...
            /* renamed from: nr */
            public static final byte f23nr = 4;
        ...
        /* renamed from: nr */
        public void mo1556nr(CellInfoNr nr) {
            this.hidl_d = 4;
            this.hidl_o = nr;
        }

        /* renamed from: nr */
        public CellInfoNr mo1555nr() {
            if (this.hidl_d != 4) {
                Object obj = this.hidl_o;
                String className = obj != null ? obj.getClass().getName() : "null";
                throw new IllegalStateException("Read access to inactive union components is disallowed. Discriminator value is " + this.hidl_d + " (corresponding to " + hidl_discriminator.getName(this.hidl_d) + "), and hidl_o is of type " + className + ".");
        ...
        public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
            ...
            switch (this.hidl_d) {
                ...
                case 3:
                    ...
                    return;
                case 4:
                    mo1555nr().writeEmbeddedToBlob(_hidl_blob, 8 + _hidl_offset);
                    return;
                case 5:
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.registered == other.registered && this.timeStampType == other.timeStampType && this.timeStamp == other.timeStamp && this.connectionStatus == other.connectionStatus && HidlSupport.deepEquals(this.ratSpecificInfo, other.ratSpecificInfo)) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.registered))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.timeStampType))), Integer.valueOf(HidlSupport.deepHashCode(Long.valueOf(this.timeStamp))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.connectionStatus))), Integer.valueOf(HidlSupport.deepHashCode(this.ratSpecificInfo))});
    }

    public final String toString() {
        return "{" + ".registered = " + this.registered + ", .timeStampType = " + TimeStampType.toString(this.timeStampType) + ", .timeStamp = " + this.timeStamp + ", .connectionStatus = " + CellConnectionStatus.toString(this.connectionStatus) + ", .ratSpecificInfo = " + this.ratSpecificInfo + "}";
    }

    public final void readFromParcel(HwParcel parcel) {
        readEmbeddedFromParcel(parcel, parcel.readBuffer(216), 0);
    }
    ...
    public static final ArrayList<CellInfo> readVectorFromParcel(HwParcel parcel) {
        ...
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 216), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            CellInfo _hidl_vec_element = new CellInfo();
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, (long) (_hidl_index_0 * 216));
            _hidl_vec.add(_hidl_vec_element);
        }
        return _hidl_vec;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.timeStampType = _hidl_blob.getInt32(4 + _hidl_offset);
        this.timeStamp = _hidl_blob.getInt64(8 + _hidl_offset);
        this.connectionStatus = _hidl_blob.getInt32(16 + _hidl_offset);
        this.ratSpecificInfo.readEmbeddedFromParcel(parcel, _hidl_blob, 24 + _hidl_offset);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<CellInfo> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            _hidl_vec.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 216));
        }
        _hidl_blob.putBlob(0, childBlob);
        parcel.writeBuffer(_hidl_blob);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt32(4 + _hidl_offset, this.timeStampType);
        _hidl_blob.putInt64(8 + _hidl_offset, this.timeStamp);
        _hidl_blob.putInt32(16 + _hidl_offset, this.connectionStatus);
        this.ratSpecificInfo.writeEmbeddedToBlob(_hidl_blob, 24 + _hidl_offset);
    }
}
