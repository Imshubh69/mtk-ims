...
public class SuppSrvConfig {
    ...
    private void initAllPara() {
        this.mNotSupportXcap = initParaBool(0, C0123R.bool.conf_not_support_xcap);
        this.mHttpProtocolScheme = initParaBool(1, C0123R.bool.conf_xcap_http);
        this.mHandleError409 = initParaBool(2, C0123R.bool.conf_handle409);
        this.mFillCompleteForwardTo = initParaBool(3, C0123R.bool.conf_fill_complete_forward_to);
        this.mXcapNsPrefixSS = initParaBool(4, C0123R.bool.conf_xcap_nsprefixss);
        this.mNeedIMSDereg = initParaBool(5, C0123R.bool.conf_imsdereg);
        this.mAppendCountryCode = initParaBool(6, C0123R.bool.conf_append_countrycode);
        this.mSupportMediaTag = initParaBool(7, C0123R.bool.conf_mediatag);
        this.mPutWholeCLIR = initParaBool(8, C0123R.bool.conf_putwholeclir);
        this.mQueryWholeSimServ = initParaBool(9, C0123R.bool.conf_querywholesimserv);
        this.mDisableEtag = initParaBool(10, C0123R.bool.conf_disable_etag);
        this.mHttpErrToUnknownHostErr = initParaBool(11, C0123R.bool.conf_httperr_to_unknownhost);
        this.mUseXCAPTypeApn = initParaBool(12, C0123R.bool.conf_use_xcap_apn);
        this.mUseInternetTypeApn = initParaBool(13, C0123R.bool.conf_use_internet_apn);
        this.mNoReplyTimeInsideCFAction = initParaBool(14, C0123R.bool.conf_noreplytimer_inside_cf);
        this.mTimeSlot = initParaBool(15, C0123R.bool.conf_support_time_slot);
        this.mSaveWholeNode = initParaBool(16, C0123R.bool.conf_save_whole_node);
        this.mSetCFNRcWithCFNL = initParaBool(17, C0123R.bool.conf_set_cfnrc_with_cfnl);
        this.mNotSupportCFNotRegistered = initParaBool(18, C0123R.bool.conf_not_support_cfnl);
        this.mSupportPutCfRoot = initParaBool(19, C0123R.bool.conf_support_put_cf_root);
        this.mAttrNeedQuotationMark = initParaBool(20, C0123R.bool.conf_attr_need_quaotation_mark);
        this.mFwdNumUseSipUri = initParaBool(21, C0123R.bool.conf_fwd_num_use_sip_uri);
        if (initParaBool(22, C0123R.bool.conf_support_plus_to_url)) {
            SystemProperties.set("persist.vendor.mtk.xcap.rawurl", "true");
        } else {
            SystemProperties.set("persist.vendor.mtk.xcap.rawurl", "false");
        }
        this.mSupportPutNonUriNumber = initParaBool(23, C0123R.bool.conf_support_put_non_uri_number);
        this.mElementContentType = initParaString(0, C0123R.string.conf_eleupdatetype);
        this.mAUID = initParaString(1, C0123R.string.conf_auid);
        this.mXcapRoot = initParaString(2, C0123R.string.conf_xcap_root);
        initRuleId();
        this.mDigestId = initParaString(8, C0123R.string.conf_digest_id);
        this.mDigestPwd = initParaString(9, C0123R.string.conf_digest_pwd);
        this.mPhoneContext = initParaString(10, C0123R.string.conf_phone_context);
        this.mPort = initParaInteger(0, C0123R.integer.conf_xcap_port);
        this.mMediaTagType = initParaInteger(1, C0123R.integer.conf_mediatag_type);
        this.mDataKeepAliveTimer = initParaInteger(2, C0123R.integer.conf_data_keep_alive_timer);
        this.mRequestDataTimer = initParaInteger(3, C0123R.integer.conf_request_data_timer);
        this.mDataCoolDownTimer = initParaInteger(4, C0123R.integer.conf_data_cool_down_timer);
        this.mCacheValidTime = initParaLong(0, C0123R.string.conf_cache_value_time);
    }
    ...
    private long initParaLong(int idx, int res) {
        ...
        if (r == -1) {
            r = Long.parseLong(this.mContext.getResources().getString(res));
        }
    ...
    private int getSysPropForBool(int idx) {
        ...
        if (idx > -1) {
            ...
            if (which > 0 && ((1 << idx) & which) != 0) {
                if (((1 << idx) & SystemProperties.getInt(SYS_PROP_BOOL_VALUE, 0)) != 0) {
                    i = 1;
                }
                r = i;
    ...
    private void initRuleId() {
        String cfu = initParaString(3, C0123R.string.conf_ruleid_cfu);
        String cfb = initParaString(4, C0123R.string.conf_ruleid_cfb);
        String cfnry = initParaString(5, C0123R.string.conf_ruleid_cfnry);
        String cfnrc = initParaString(6, C0123R.string.conf_ruleid_cfnrc);
        String cfnl = initParaString(7, C0123R.string.conf_ruleid_cfnl);
        HashMap hashMap = new HashMap();
        this.mRuleId = hashMap;
        hashMap.put(RULEID_CFU, cfu);
    ...
    public boolean isSupportPutNonUriNumber() {
        return this.mSupportPutNonUriNumber;
    }
}
