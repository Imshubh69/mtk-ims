...
public class ImsRadioIndicationV2 extends ImsRadioIndicationBaseV2 {
    private static final int INVALID_CALL_MODE = 255;
    private int mPhoneId;
    private ImsRILAdapter mRil;

    ImsRadioIndicationV2(ImsRILAdapter ril, int phoneId) {
        this.mRil = ril;
    ...
    public void sendVopsIndication(int indicationType, int vops) {
        int[] ret = {vops};
        ImsRILAdapter imsRILAdapter = this.mRil;
        imsRILAdapter.riljLog("ImsRILConstants.RIL_UNSOL_VOPS_INDICATION, " + vops + " phoneId = " + this.mPhoneId);
