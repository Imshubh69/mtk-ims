...
import vendor.mediatek.hardware.mtkradioex.V3_0.IImsRadioIndication;
...
public class ImsRadioIndicationBase extends IImsRadioIndication.Stub {
    ...
    public void eregrtInfoInd(int indicationType, ArrayList<Integer> arrayList) {
        riljLoge("No implementation in eregrtInfoInd");
    }
    ...
    public void imsRegFlagInd(int type, int flag) {
        riljLoge("No implementation in imsRegFlagInd");
    }
