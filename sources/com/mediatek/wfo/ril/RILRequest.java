...
/* compiled from: MwiRIL */
class RILRequest {
    static final String LOG_TAG = "MwiRIL-RilRequest";
    ...
    public void onError(int error, Object ret) {
        ...
        Rlog.d(LOG_TAG, serialString() + "< " + MwiRIL.requestToString(this.mRequest) + " error: " + ex + " ret=" + MwiRIL.retToString(this.mRequest, ret));
